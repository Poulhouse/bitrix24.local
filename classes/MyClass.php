...
class MyClass
{
     ...
     */
    public static function changeContactToCompany($entityTypeId, $idContact): void
    {
        $fields = [];
        if ($entityTypeId == 175) {
            $fieldObjectId = 51;
    ...
    public static function getDataOfForm($entityId, $entityTypeId): string
    {
    ...
    private static function bizProc($IBLOCK_ID, $elementId, int $AUTO_EXECUTE = 0): ?string
    {
        global $USER;
    ...
    public static function my_onMailMessageModified(&$event, &$fields, &$filter): void
    {
        Logs\File::AddMessage($event, "event", LOG_MYCLASS);
        Logs\File::AddMessage($fields, "fields", LOG_MYCLASS);
        Logs\File::AddMessage($filter, "filter", LOG_MYCLASS);
    }
    public static function OnBeforeMailSend(&$arFields): void
    {
    ...
    public static function OnBeforeChatMessageAddHandler(&$arMessageFields): bool
    {
	...
	public static function openForm($idZayavki): void
    {
	...
	public static function MyOnPrologHandler(): void
    {
	...
	public static function generatePasswordActivity($phoneNumber = "000"): array
    {
		$dataG = array();
		$phone = "+".$phoneNumber;
		$data['phone'] = $phone;
	...
	public static function generatePassword($phoneNumber): false|string
    {
		$dataG = array();
		$phone = "+".$phoneNumber;
		$data['phone'] = $phone;
	...
	public static function addressUpdate($id, $entityTypeId, $dataField, $nameField, $typeId): bool
    {
		global $DB;
	...
	public static function updateTemplateRQ($rqId): null
    {
		return null;
	}

	public static function OnAfterCrmLeadUpdateHandler(&$arFields): void
    {
	...
	public static function proverkaExistID($idLead, $r = false): bool
    {
		if(!$r) {
	...
	public static function getItemsBySourceId(string $sourceId,int $limit): array
    {
		global $DB;
		$result = [];
	...
	public static function getOldSourceIDFromLeadTimeline($leadId): array
    {
		global $DB;
	...
	public static function updateLocationAddressByCRMId($ID): array
    {
		global $DB;
	...
	public static function fail_getWorkingDays(\DateTime $startDate, \DateTime $endDate): float|int
    {
	...
	public static function getWorkingDays(\DateTime $startDate, \DateTime $endDate): float|int
    {
	...
	public static function getPathPersonalPhotoByUserId($userId): ?string
    {
	...
	public static function getSUMSCPKBSellerByCompanyINN($params = array()): float|int
    {
		$innReferral = $params['innReferral'];
	...
	public static function setParamsForDealReferral($dealID): array
    {
		$params = [
			'order' => ['ID' => 'ASC'],
			'filter' => [
	...
	public static function setParamsForLeadSeller($leadID, $order,$mounth): array
    {
	...
	public static function setParamsForDogovorZaim($DZID, $idReferral): array
    {
		$params = [
			'entityTypeId' => 188,
			'order' => ['ID' => 'ASC'],
	...
	public static function get_all($method = "", $order="ASC", $mounth=null): array
    {
	...
	public static function getQTYDogovorZaimByReferralID($idReferral): array
    {
