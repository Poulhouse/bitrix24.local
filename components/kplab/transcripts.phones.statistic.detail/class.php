...
class CTranscriptsPhonesStatisticDetailComponent extends CBitrixComponent implements \Bitrix\Main\Engine\Contract\Controllerable, \Bitrix\Main\Errorable
{
    ...
    protected $gridId = "transcripts_phones_statistic_detail";
    protected $filterId = "transcripts_phones_statistic_detail_filter";
    ...
    protected function prepareData()
    {
        ...
        $this->arResult["HEADERS"] = array(
            ...
            array("id" => "TRANSCRIPT_TEXT", "name" => "Распознание речи", "default" => true, "editable" => false),
        );
    }
