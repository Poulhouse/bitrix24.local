...
while ($route = $res->fetch()) {
    $routes[] = [
        ...
        'actions' => [
            [
                'text' => 'Изменить',
                'onclick' => "document.location.href='kplab.api.v2_routes_edit.php?ID=" . $route['ID'] . "'"
            ],
            [
                'text' => 'Удалить',
...
?>
    <div class="adm-toolbar-panel-container">
        ...
        <div class="adm-toolbar-panel-align-right">
            <button onclick="document.location.href='kplab.api.v2_routes_add.php'" class="ui-btn ui-btn-primary">Добавить маршрут</button>
        </div>
    </div>
<?php
