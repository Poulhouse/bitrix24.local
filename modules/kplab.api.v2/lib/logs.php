...
class LogsAction
{
    ...
    {
        // Получаем настройки
        $serverNameProd = Option::get('kplab.api.v2', 'server_name_prod', '');
        $serverNameTest = Option::get('kplab.api.v2', 'server_name_test', '');
        $iblockId = Option::get('kplab.api.v2', 'iblock_id', '');
        $iblockIdTest = Option::get('kplab.api.v2', 'iblock_id_test', '');
        $propertyIDToken = Option::get('kplab.api.v2', 'property_token', '');
