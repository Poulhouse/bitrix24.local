    ...
    public static function getAll(string $languageId): array
    {
        return [
            ...
            'RU_2' => [
                ...
                'templateCollection' => [
                    TemplateType::DEFAULT =>
                        '["#S#",[POSTAL_CODE,COUNTRY,ADM_LEVEL_1,ADM_LEVEL_2,LOCALITY,ADDRESS_LINE_1:N,ADDRESS_LINE_2]]',
                    TemplateType::AUTOCOMPLETE => '["#S#",[POSTAL_CODE,COUNTRY,ADM_LEVEL_1,ADM_LEVEL_2,LOCALITY,ADDRESS_LINE_1:N,ADDRESS_LINE_2]]',
                    TemplateType::ADDRESS_LINE_1 => '["#S#",[STREET,BUILDING]]',
                ],
                'code' => 'RU_2',
                'fieldForUnRecognized' => FieldType::ADDRESS_LINE_2,
                'fieldCollection' => [
                    ...
                    [
                        ...
                        'name' => Loc::getMessage('LOCATION_REPO_FRMT_STREET', null, $languageId),
                        'description' => 'Улица'
                    ],
                    ...
                    [
                        'sort' => 400,
                        'type' => FieldType::BUILDING,
                        'name' => Loc::getMessage('LOCATION_REPO_FRMT_BUILDING', null, $languageId),
