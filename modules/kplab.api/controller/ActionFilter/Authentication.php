...
file_put_contents($_SERVER["DOCUMENT_ROOT"] . "/local/logs/auth_debug.log", print_r($_SERVER, true), FILE_APPEND);
...
final class Authentication extends Base
{
	...
	{
        file_put_contents($_SERVER["DOCUMENT_ROOT"] . "/local/logs/auth_debug.log", "Запрос в Authentication\n", FILE_APPEND);
