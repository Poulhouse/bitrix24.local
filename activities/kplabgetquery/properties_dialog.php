...
<div class="request-container">
    ...
    <div class="request-settings">
        ...
        <div id="method_row">
            ...
            <select id="method" name="method">
                <option value="GET" <?= ($arResult['arCurrentValues']["method"] == "GET" ? "selected" : "") ?>>GET</option>
            </select>
        </div>
    ...
    <div class="request-section">
        ...
        <div class="json-actions">
            <button type="button" onclick="addParam()">Добавить параметр</button>
        </div>
    </div>
    <div class="query_params">
        <textarea id="query_params" name="query_params"><?= htmlspecialcharsbx($arResult['arCurrentValues']["query_params"]) ?></textarea>
        <div class="json-actions">
            <button type="button" id="generateBtn" onclick="generateQueryString()">Сформировать строку запроса</button>
...
Asset::getInstance()->addJs("/local/activities/kplabgetquery/scripts/script.js");
?>
<script>
