...
$arActivityDescription = [
	...
	'CLASS' => 'KPLabCrmGetDynamicInfoActivity',
	...
	'PRESETS' => [
		[
			'ID' => 'dynamic',
			'NAME' => Loc::getMessage('CRM_GDIA_ROBOT_NAME_DIGITAL_WORKPLACE'),
			'DESCRIPTION' => Loc::getMessage('CRM_GDIA_ROBOT_DESCRIPTION_DIGITAL_WORKPLACE_MSGVER_1'),
			'PROPERTIES' => [
    ...
    'RETURN' => array(
        'DynamicEntityFields' => array(
            'NAME' => 'ID элементов',
            'TYPE' => 'string',
            'MULTIPLE' => 'Y', // Указываем, что может быть несколько значений
        ),
    ),
