...
<!-- Кнопки переключения типов очередей -->

<!-- Основной блок контента -->
<div class="intranet-contact-block" style="margin-left: -13.8px; margin-top: -13.8px;">
	<div class="disconnect_btn">
		<a href="javascript:void(0);" class="ui-btn im-phone-call-btn-red" onclick="crmListModule.disconnect();">Отключиться от всех</a>
	...
	<div class="intranet-contact-wrap">
		<div class="intranet-contact-list" style="align-items: normal;">
			...
			<div class="intranet-contact-center-item-block">
									<div data-col="742" class="intranet-contact-item" style="background-color: #999933;">
						<div class="intranet-contact-logo-container">
		
						</div>
							<div class="intranet-contact-name" style="text-align:center">
																
									
															<span class="intranet-contact-name-text">Дневные Ипотека</span>
						</div>
					</div>
					<br>
									<div data-col="746" class="intranet-contact-item intranet-contact-item-selected" style="background-color: #669966;">
						<div class="intranet-contact-logo-container">
							
						</div>
							<div class="intranet-contact-name" style="text-align:center">
																	<span class="intranet-contact-name-text" style="color:red">
							</span>
									<br>
															<span class="intranet-contact-name-text">Общие</span>
						</div>
					</div>
					<br>
									<div data-col="752" class="intranet-contact-item intranet-contact-item-selected" style="background-color: #33991a;">
						<div class="intranet-contact-logo-container">
							...
							<div class="intranet-contact-name" style="text-align:center">
									...
									<br>
															<span class="intranet-contact-name-text">Сбережения Дневные</span>
						</div>
					</div>
					<br>
									<div data-col="759" class="intranet-contact-item intranet-contact-item-selected" style="background-color: #10a10b;">
						<div class="intranet-contact-logo-container">

						</div>
							<div class="intranet-contact-name" style="text-align:center">
															<span class="intranet-contact-name-text">Займы Предпринимателям Дневные</span>
						</div>
					</div>
					<br>
							</div>
